...
THREE.OculusRiftEffect = function ( renderer, options ) {
	...
	var renderTarget = new THREE.WebGLRenderTarget( HMD.renderTargetW, HMD.renderTargetH, RTParams );
	...
	this.setHMD = function(v) {
		...
		renderTarget = new THREE.WebGLRenderTarget( HMD.renderTargetW, HMD.renderTargetH, RTParams );
